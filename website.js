...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('italianRestaurant.xml', 'utf8');
    var xsl = fs.readFileSync('italianRestaurant.xsl', 'utf8');
...
router.post('/post/json', function(req, res) {
  ...
  function appendJSON(obj) {
    ...
    xmlFileToJs('italianRestaurant.xml', function(err, result) {
      if (err) throw (err);
      result.restaurantmenu.section[obj.sec_n].entree.push({'item': obj.item, 'price': obj.price,'description': obj.description});
      console.log(result);
      jsToXmlFile('italianRestaurant.xml', result, function(err) {
